...
resource "oci_core_route_table" "public_route_table" {
  	...
  	route_rules {
    	network_entity_id = var.create_internet_gateway ? oci_core_internet_gateway.internet_gateway[0].id : var.drg_id
...
resource "oci_core_route_table" "private_route_table" {
  	...
  	route_rules {
    	network_entity_id = var.create_nat_gateway ? oci_core_nat_gateway.nat_gateway[0].id : var.drg_id
    	destination       = "0.0.0.0/0"
    	destination_type  = "CIDR_BLOCK"
  	}
}
